...
namespace SimpleTweaksPlugin.Tweaks.UiAdjustment {
    public unsafe class GearPositionsDex : UiAdjustments.SubTweak {
        ...
        private void* InspectOnSetup(AtkUnitBase* atkUnitBase, int a2, void* a3) {
			...
			MoveNode(atkUnitBase, 14, 0, 46 * 6); // Off Hand
			...
			MoveNode(atkUnitBase, 15, 0, 46 * 6); // Off Hand
        ...
        private void* CharacterOnSetup(AtkUnitBase* atkUnitBase, int a2, void* a3) {
			...
			MoveNode(atkUnitBase, 49, -8, 242); // Off Hand
			...
			MoveNode(atkUnitBase, 47, 0, 343); // Off Hand
